...
Google and other search engines use web crawlers to index and rank your website. Robots.txt is a file which contains guidelines for how these crawlers should index your website. You can mention which URLs to crawl and which shouldn't be crawled.

...
Google and other search engines use web crawlers to index and rank your website. Robots.txt is another file which contains guidelines for how these crawlers should 

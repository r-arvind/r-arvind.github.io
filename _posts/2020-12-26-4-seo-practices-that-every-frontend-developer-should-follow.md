...
The title tag `<title></title>` is nothing but the title of your website. It is displayed on the browser tab. The title should be relevant to your website and include all the necessary keywords. For example, if your website is for a specific brand, make sure your title always has the brand name. The home page should be "Home | Brand", the about page should be "About Us | Brand" and so on.
